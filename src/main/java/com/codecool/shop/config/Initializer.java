...
public class Initializer implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent sce) {
        SupplierDaoJdbc asd = SupplierDaoJdbc.getInstance();
        //System.err.println("asdfghjk: " + asd.find(1).getName());

        /*for (Supplier sup: asd.getAll()) {
            System.err.println("asdfghjk: " + sup.getName());
        }*/
        ...
        productDataStore.add(new Product("The Bible Flask", 25.0f, "USD", "The good book with a flask. Yes, this bible cleverly sneaks in a 4 oz stainless steel flask inside of the hollowed out pages.", booze, catholicChurch));
        ...
        productDataStore.add(new Product("Umbrella Flask", 14.00f, "USD", "Fake Umbrella Flask holds 9 oz. of your favorite party beverage!", booze, umbrellaFactory));
        productDataStore.add(new Product("Porn For Women", 25, "USD", "Laugh out loud while relating to this sexy, smart book featuring strapping men doing housework.", forWomen, alexandra));
        productDataStore.add(new Product("Scotch-Infused Toothpicks Gift Set", 30.00f, "USD", "Savor the subtle satisfaction of fine single malt scotch with these infused toothpicks.", forMan, toothpickSupplier));
