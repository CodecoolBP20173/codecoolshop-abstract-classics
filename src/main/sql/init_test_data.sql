...
INSERT INTO public.product (name, description, default_price, default_currency, product_category_id, supplier_id,product_image) VALUES ('The Bible Flask', 'The good book with a flask. Yes, this bible cleverly sneaks in a 4 oz stainless steel flask inside of the hollowed out pages.', 25, 'USD', 3, 3, '/static/img/product_2');
INSERT INTO public.product (name, description, default_price, default_currency, product_category_id, supplier_id,product_image) VALUES ('Boobie Bag Soft Flask', 'INSTANT BOOB JOB!  Our Boobie Bags will give you a 4 oz “lift” each side while comfortably  hidden in your bra.', 12, 'USD', 3, 4, '/static/img/product_3');
...
INSERT INTO public.product (name, description, default_price, default_currency, product_category_id, supplier_id,product_image) VALUES ('Porn For Women', 'Laugh out loud while relating to this sexy, smart book featuring strapping men doing housework.', 25, 'USD', 4, 6, '/static/img/product_5');
INSERT INTO public.product (name, description, default_price, default_currency, product_category_id, supplier_id,product_image) VALUES ('Scotch-Infused Toothpicks Gift Set', 'Savor the subtle satisfaction of fine single malt scotch with these infused toothpicks.', 30, 'USD', 5, 7, '/static/img/product_6');
INSERT INTO public.product (name, description, default_price, default_currency, product_category_id, supplier_id,product_image) VALUES ('Elwood the Unicorn Cereal Bowl', 'Elwood the unicorn turns a simple bowl of cereal, soup, or ice cream into a walk on the wondrous side.', 42, 'USD', 4, 8, '/static/img/product_7');
...
INSERT INTO public.product (name, description, default_price, default_currency, product_category_id,supplier_id,product_image) VALUES ('Cat Battle Armor', 'If your cat spends any time out in the wild it’s time to level them up with this cat battle armor. Your cat will…', 500, 'USD', 8, 1, '/static/img/product_9');